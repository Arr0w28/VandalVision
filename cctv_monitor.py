...
class VandalismDetector:
    def __init__(self):
        ...
        self.detection_interval = 1  # 0.5 seconds between detections
    ...
    def is_holding(self, person_bbox, bottle_bbox):
        # Simple check: if the bottle's center is within the person's bounding box
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        print("MainWindow initialized")  # Debug output
